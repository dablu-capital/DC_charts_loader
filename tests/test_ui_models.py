...
class TestDualChartPlotter:
    ...
    def test_init_without_chart2_data(self, mock_chart_class, mock_charts_minute_data):
        ...
        mock_chart_class.assert_called_once_with(
            inner_width=0.5, inner_height=1.0, toolbox=True
        )
    ...
    def test_setup(
        ...
        assert (
            mock_chart.topbar.button.call_count >= 3
        )  # maximize, clear, measurement buttons
...
class TestDoubleClickTracker:
    ...
    def test_first_click(self):
        ...
        test_data = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 100.0}
    ...
    def test_second_click_distance_calculation(self):
        ...
        # First click
        first_click = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 100.0}
        mock_chart = Mock()
        mock_chart.id = "test_chart"
        ...
        second_click = {"timestamp": datetime(2023, 1, 2, 10, 0, 0), "price": 150.0}
    ...
    def test_price_difference_calculation(self):
        ...
        first_click = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 200.0}
        second_click = {"timestamp": datetime(2023, 1, 1, 11, 0, 0), "price": 150.0}
    ...
    def test_time_difference_calculation(self):
        ...
        first_click = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 100.0}
        second_click = {"timestamp": datetime(2023, 1, 1, 22, 0, 0), "price": 100.0}
    ...
    def test_multi_chart_support(self):
        ...
        test_data1 = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 100.0}
        tracker.handle_click(test_data1, chart1)

        # Second click on chart2 (should work across charts)
        tracker.set_chart(chart2)
        test_data2 = {"timestamp": datetime(2023, 1, 2, 10, 0, 0), "price": 150.0}
        ...
        assert (
            len(tracker.current_drawings["chart2"]) == 2
    ...
    def test_separate_tracker_instances(self):
        ...
        # First click on main chart
        main_data = {"timestamp": datetime(2023, 1, 1, 10, 0, 0), "price": 100.0}
        double_click_tracker.handle_click(main_data, main_chart)

        # First click on right chart
        right_data = {"timestamp": datetime(2023, 1, 1, 11, 0, 0), "price": 200.0}
